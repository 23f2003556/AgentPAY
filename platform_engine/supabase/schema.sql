-- AgentPay schema (Person B)
-- Paste into Supabase Dashboard -> SQL Editor -> New query -> Run.
-- After running, enable Realtime on the `payments` table:
--   Database -> Replication -> add `payments`.
...
-- Expect: services, reputation, payments
